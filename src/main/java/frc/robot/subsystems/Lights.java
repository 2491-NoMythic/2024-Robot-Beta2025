...
public class Lights extends SubsystemBase {
  ...
  // All setLights methods are based on having four rows of fifteen lights,
  // divided into three
  // sections.
  ...
  /**
   * Set each side to 2 seperate colors based on a given position 11122-----22111 ^pos
   *
  ...
  /**
   * set lights based on a distance from 0 when the absolute value of progress is greater than 1 all
   * lights are color 1 when the absolute value of progress is near 0 all lights are color 2 when
   * the absolute value of progress is in between 0 and 1 some lights will be color 1 and some will
   * be color 2
   */
