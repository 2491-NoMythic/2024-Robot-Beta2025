...
public class Climber extends SubsystemBase {
  ...
  public Climber() {
    ...
    climbMotorL.configure(
        climbMotorLConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
    ...
    climbMotorR.configure(
        climbMotorRConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
  ...
  public void periodic() {
    currentEncoderRotationsL =
        Math.abs(Math.abs(climbEncoderL.getPosition()) - initialEncoderRotationsL);
    currentEncoderRotationsR =
        Math.abs(Math.abs(climbEncoderR.getPosition()) - initialEncoderRotationsR);
