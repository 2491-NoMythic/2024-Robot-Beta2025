...
public class IndexerSubsystem extends SubsystemBase {
  ...
  /**
   * uses the indexer motor's onboard Motion Magic control to move the indexer forward. To move
   * backwards, use negative inches.
   *
  ...
  public void magicRPSSupplier(DoubleSupplier RPSSupplier) {
    MotionMagicVelocityVoltage speedRequest =
        new MotionMagicVelocityVoltage(RPSSupplier.getAsDouble());
    m_IndexerMotor.setControl(speedRequest);
  }
