...
public final class Constants {
  ...
  public static final class ShooterConstants {
    ...
    // the PID values used on the PID loop on the motor controller that control the
    // position of the
    // shooter angle
    ...
    /**
     * the values used when adjusting the shooter's angle based on our speaker distance. Here's how
     * we calculated them:
     *
     * <p>shoot at the speaker from various distance, and calculate how far under the target we miss
     * (could be negative if we miss above the target). Then graph these points on desmos where the
     * x-axis is distance-from-speaker (as calculated by the code), and the y-axis is how far under
     * the target we missed. Using desmos, find the equation that fits these points as best we can.
     * This might be a quadratic, cubic, or maybe exponential equation. Then, use the a, b, and c
     * values from desmos as these constants.
     */
    ...
    // public static final double COMP_ADJUST_EQUATION_D = 1; unused becuase we
    // aren't using a cubic
    // equation
    /**
     * the value that the encoder thinks is zero. when the shooter is resting on the bottom stop,
     * the encoder should read 11.63
     */
    public static final double CompBotZeroOffset =
        155.2; // before rebuild was 334.7. After rebuild right away was
    // 155.57
  ...
  public static final class IndexerConstants {
    ...
    public static final double INDEXER_INTAKE_SPEED =
        1 * 0.6; // 0.903 ;//speed to pick up at 10 ft/s
    public static final double HUMAN_PLAYER_INDEXER_SPEED =
        -0.5; // should be 0.5 TODO change to positive
    ...
    public static final double INDEXER_ACCELERATION =
        800; // at 400 acceleration, the motor takes 0.1 seconds to reach
    // 40 RPS
    /** the jerk to target when moving to a set acceleration. In RPS^3. */
    public static final double INDEXER_JERK =
        8000; // at 4000 jerk, the motor takes 0.4 seconds to reach 400 RPS^2
    /**
     * multiply motor rotations by this value to get inches. Divide inches by this value to get
     * motor rotations.
     */
  ...
  public static final class IntakeConstants {
    ...
    /**
     * the desired speed for the intake when doing ground intake. In Percent-of-full-power, from -1
     * to 1
     */
    public static final double INTAKE_SPEED =
        0.65 * 0.6; // 0.5834 ; // ground intakes speed. 0.4167 picks up at 10
    // ft/s
  ...
  public final class Field {
    ...
    public static final double AMP_SIDE_OUTER_TAPE_CORNER_RED_X =
        AMP_SIDE_OUTER_TAPE_CORNER_RED_ROBOT_X - ROBOT_CENTER_TO_BUMBER;
    public static final double AMP_SIDE_OUTER_TAPE_CORNER_RED_Y =
        AMP_SIDE_OUTER_TAPE_CORNER_RED_ROBOT_Y + ROBOT_CENTER_TO_BUMBER;
    public static final double AMP_SIDE_OUTER_TAPE_CORNER_BLUE_X =
        AMP_SIDE_OUTER_TAPE_CORNER_BLUE_ROBOT_X + ROBOT_CENTER_TO_BUMBER;
    public static final double AMP_SIDE_OUTER_TAPE_CORNER_BLUE_Y =
        AMP_SIDE_OUTER_TAPE_CORNER_BLUE_ROBOT_Y - ROBOT_CENTER_TO_BUMBER;

    public static final double CALCULATED_SHOOTER_RED_SPEAKER_X =
        AMP_SIDE_OUTER_TAPE_CORNER_RED_X + 3.213;
    ...
    public static final double ROBOT_RED_SPEAKER_X =
        SHOOTER_RED_SPEAKER_X
            - 0.165; // changed so that shots from the side wil aim to the opposite side, and bank
    // in

    public static final double CALCULATED_SHOOTER_BLUE_SPEAKER_X =
        AMP_SIDE_OUTER_TAPE_CORNER_BLUE_X
            - 3.213; // changed so that shots from the side wil aim to the opposite side, and bank
    // in
    public static final double CALCULATED_BLUE_SPEAKER_Y =
        AMP_SIDE_OUTER_TAPE_CORNER_BLUE_Y + 1.263;
    ...
    public static final double SPEAKER_Z =
        2.08; // 1.5;//1.8;//2.08; //height of opening. Changed so that the smaller
    // spekeaker_x
    // shots will still go in
  ...
  public final class PathConstants {
    ...
    // Here the fine beasts of the Pathplanner Period reside, after being brought
    // back through DNA
