...
public class AimRobotMoving extends Command {
  ...
  /**
   * a command to automatically aim the robot at the speaker if odometry is correct. This command
   * also controls aiming from setpoints incase the odometry isn't working.
   *
   ...
   * @param SubwooferAngleSup the button to use the subwoofer setpoint (doesn't turn the robot, but
   *     stops the robot from auto-aiming when you rev up)
