...
public class AimShooter extends Command {
  ...
  /**
   * A Command that will control the angle of the shooter. If none of the supplied buttons are
   * pressed, than it will automatically aim at the speaker
   *
   ...
   * @param SubwooferSupplier1 a button to set the shooter to the correct speaker angle while the
   *     robot is against the subwoofer
   * @param StageAngleSupplier a button to set the shooter to the correct speaker angle while the
   *     robot is against the podium
   * @param groundIntakeSup a button to set the shooter to the correct angle for a succesful ground
   *     intake
   * @param farStageAngleSup a button to set the shooter to the correct speaker angle while the
   *     robot is against the far stage leg
